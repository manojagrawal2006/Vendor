        ...
        <asp:Repeater ID="Repeater1" runat="server">
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td><asp:Label id="lblPackageType"  Width="100%" Height="100%"  runat="server"><%# Eval("Package_Type_Id") %></asp:Label>
                        <asp:HiddenField id="hPackageType" runat="server" Value='<%# Eval("Package_ID") %>' />
